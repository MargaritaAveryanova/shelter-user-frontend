        ...
        <div style={{position: "absolute", marginTop: "-32vw", marginLeft: "21vw"}}>
          ...
          <div className='flower'>
            <svg viewBox="0 0 112 111" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0_3128_157)">
                ...
                <g mask="url(#mask0_3128_157)">
                  <path d="M55.9587 110.693C86.4369 110.693 111.144 85.9859 111.144 55.5076C111.144 25.0294 86.4369 0.321899 55.9587 0.321899C25.4804 0.321899 0.772949 25.0294 0.772949 55.5076C0.772949 85.9859 25.4804 110.693 55.9587 110.693Z" fill="var(--help)"/>
                </g>
              </g>
              <defs>
            ...
            <div className={`bloop_love_1 ${!showAllPets ? 'd-none d-md-block' : ''}`}>
              <svg width="15vw" height="19vw" viewBox="0 0 309 349" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M67.9392 13.0693C128.544 41.7294 184.015 26.2951 223.699 4.43077C244.995 -7.302 279.588 10.2075 277.159 34.3995L262.109 184.329C261.664 188.767 262.412 193.243 264.278 197.294L306.473 288.925C309.485 295.465 309.585 303.164 306.203 309.521C246.41 421.912 144.645 252.984 90.7498 258.264C81.8359 259.137 72.2079 262.458 65.1427 256.953C1.20985 207.139 -43.1718 -39.4748 67.9392 13.0693Z" fill="var(--biege-block)"/>
              </svg>
            </div>
            ...
            <div className={`bloop_love_1_2 ${!showAllPets ? 'd-md-none d-block' : ''}`}>
              <svg width="60vw" height="50vw" viewBox="0 0 217 88" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M64.8526 9.93705C144.009 7.36275 178.817 2.99789 193.353 0.320034C198.403 -0.610259 204.039 2.65729 205.188 7.66183L216.721 57.889C218.084 63.8231 212.654 69.1035 206.674 67.9588C139.996 55.1943 148.638 92.1825 64.8526 86.6323C20.2107 81.5593 -55.2725 13.8437 64.8526 9.93705Z" fill="var(--biege-block)"/>
              </svg>
            </div>
          ...
          <div className="two_love">
              ...
              <svg viewBox="0 0 112 111" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_3128_145)">
                  ...
                  <g mask="url(#mask0_3128_145)">
                    <path d="M56.1579 110.694C86.6362 110.694 111.344 85.986 111.344 55.5078C111.344 25.0295 86.6362 0.322021 56.1579 0.322021C25.6797 0.322021 0.972168 25.0295 0.972168 55.5078C0.972168 85.986 25.6797 110.694 56.1579 110.694Z" fill="var(--help)"/>
                  </g>
                </g>
                <defs>
            ...
            <div className={`bloop_love_2 ${!showAllPets ? 'd-none d-md-block' : ''}`}>
              ...
              <path d="M102.612 30.7457C177.741 23.158 227.661 12.4093 260.568 2.17656C282.866 -4.75735 324.83 17.199 326.552 40.4868L343.845 274.362C345.444 295.991 319.83 308.747 298.613 304.256C222.964 288.242 221.922 432.729 102.612 408.185C31.8668 383.22 -87.7529 49.9716 102.612 30.7457Z" fill="var(--biege-block)"/>
              </svg>
            </div>
